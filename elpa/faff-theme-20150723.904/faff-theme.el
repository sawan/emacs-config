...
(custom-theme-set-faces
 ...
 '(magit-branch-local ((t (:background "yellow" :box (:line-width 1 :color "grey75" :style released-button)))))
 '(magit-branch-remote ((t (:foreground "DarkOliveGreen4" :box (:line-width 1 :color "grey75" :style released-button)))))
 '(magit-diff-add ((t (:inherit diff-added))))
 '(magit-diff-del ((t (:inherit diff-removed))))
 '(magit-diff-none ((t (:inherit diff-context))))
 '(magit-header ((t (:inherit header-line :background "white"))))
 '(magit-item-highlight ((t (:inherit highlight))))
 '(magit-section-heading ((t (:box (:line-width 1 :color "grey75" :style pressed-button)))))
