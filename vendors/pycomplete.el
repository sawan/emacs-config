...
(define-key py-mode-map [S-f1] 'py-complete-help-thing-at-point)
(define-key py-mode-map "(" 'py-complete-electric-lparen)
(define-key py-mode-map "," 'py-complete-electric-comma)
(define-key py-mode-map [S-f2] 'py-complete-signature-expr)
(define-key py-mode-map [S-f3] 'py-complete-help)
