...
(defhydra hydra-origami()
  ...
  ("u" origami-undo "undo")
  ("r" origami-redo "redo")
  ("R" origami-reset :color blue "Reset")
  ("q" nil :color blue)
  ("<ESC>" nil :color blue)
  )

(global-set-key (kbd "<f6>") 'hydra-origami/body)
